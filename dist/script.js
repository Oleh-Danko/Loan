    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          ...
          blockedElem.setAttribute('data-disabled', 'true'); // if (i % 2 == 0) {
          //     blockedElem.setAttribute('data-disabled', 'true');
          // }
        } catch (e) {} // console.log(blockedElem);
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindTrigger",
    value: function bindTrigger(trigger, num) {
      var _this2 = this;
    ...
    value: function render() {
      if (this.container) {
        ...
        this.bindTrigger(this.prevModule, -1); // this.bindTrigger(this.nextModule, 1);
      }
    }
  }]);
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, opacity) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, opacity));
  }
